...
export type CollectionNodeFragment = (
  ...
  & { image?: Maybe<(
    { __typename?: 'Image' }
    & Pick<Image, 'altText' | 'id' | 'src' | 'originalSrc'>
  )>, products: (
    { __typename?: 'ProductConnection' }
    & { edges: Array<(
      { __typename?: 'ProductEdge' }
...
export type MetafieldNodeFragment = (
  { __typename?: 'Metafield' }
  & Pick<Metafield, 'description' | 'id' | 'key' | 'namespace' | 'value' | 'valueType' | 'createdAt' | 'updatedAt'>
);
...
export type ProductVariantNodeFragment = (
  ...
  & { compareAtPriceV2?: Maybe<(
    ...
    { __typename?: 'Image' }
    & Pick<Image, 'altText' | 'id' | 'originalSrc'>
  )>, metafields: (
    { __typename?: 'MetafieldConnection' }
    & { edges: Array<(
      { __typename?: 'MetafieldEdge' }
...
export type ProductNodeFragment = (
  ...
  & { images: (
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Image' }
        & Pick<Image, 'id' | 'altText' | 'originalSrc'>
      ) }
    )> }
  ), metafields: (
    { __typename?: 'MetafieldConnection' }
